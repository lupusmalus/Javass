 ...
 * @see Jass
 */
public final class ObservableJassGame {
     ...
     */
    public ObservableJassGame(long rngSeed, Map<PlayerId, Player> players, Map<PlayerId, String> playerNames) {
    ...
    private void playCards() {
        ...
        PlayerId playerId = turnState.trick().player(playerCounter);
